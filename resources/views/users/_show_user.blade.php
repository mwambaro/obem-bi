                ...
                ReactDOM.render(
                    e(
                        ObemUserShow, 
                        {
                            ...
                            is_user_validated: '<?php echo $user_data["is_user_validated"]; ?>',
                            validated_icon_url: "{{ asset('images/check.png') }}",
                            validate_label: "{{ __('obem.validate_label') }}",
                            validate_user_endpoint: '<?php echo $user_data["validate_user_endpoint"]; ?>',
                            is_admin: '<?php echo $user_data["is_admin"]; ?>',
